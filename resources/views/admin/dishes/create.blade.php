    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-md-6 card create-box">
                ...
                <div class="mb-3">
                    <label for="description" class="form-label" value="{{ old('description') }}>Inserisci descrizione piatto</label>
                    <textarea class=" form-control" name="description" id="description" rows="5"></textarea>
                        @error('description')
                        <div class="alert mt-2 alert-danger">
                            {{ $message }}
                ...
                <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" min="0.0" step="0.1" name="price" id="price"
                            class="form-control">
                        @error('price')
                            <div class="alert mt-2 alert-danger">
                                {{ $message }}
                ...
                <div class="mb-3">
                    <label for="price" class="form-label">Inserisci prezzo piatto</label>
                    <input type="number" min="0.0" step="0.1" name="price" id="price" class="form-control" value="{{ old('price') }}>
                    @error('price')
                    <div class=" alert mt-2 alert-danger">
                    {{ $message }}
                </div>
        ...
        <div class="form-check form-switch">
            <input class="form-check-input" type="checkbox" name="availability" id="availability" value="1" checked>
            <label class="form-check-label" for="availability">
                Disponibile
            </label>
        ...
        <button type="" id="btn-submit-dish-create" class="px-3 btn btn-dark text-white rounded-pill">Aggiungi</button>
    </div>
